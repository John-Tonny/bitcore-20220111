 ...
 * @constructor
 */
function MnpingMessage(arg, options) {
...
inherits(MnpingMessage, Message);

MnpingMessage.prototype.setPayload = function(payload) {
...
MnpingMessage.prototype.getPayload = function() {
  return this.raw;
};

module.exports = MnpingMessage;
